...
const Editor = ({
  ...
  return (
    <div className="flex flex-col">
      ...
      <div
        className={cn(
          "flex flex-col border border-slate-200 focus-within:border-slate-300 focus-within:shadow-sm rounded-lg transition-all duration-150 bg-white overflow-hidden",
          disabled && "opacity-50"
        )}
      >
